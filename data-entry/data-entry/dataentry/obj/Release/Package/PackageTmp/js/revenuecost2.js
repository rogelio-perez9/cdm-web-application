...
function onAddRevenueTr(ind, revenue, isDisabled) {
	...
	tr += `<th nowrap><input type="text" size="10" maxlength="10" id="amt${nn}"  name="amt${nn}"   value="${revenue?.amt || ''}"></th>`
...
function onAddCostTr(ind, cost) {
	...
	tr += `<th nowrap><input type="text" size="10" maxlength="10" id="cost${nn}"  name="cost${nn}"   value="${cost?.cost || ''}"></th>`
