	...
	$.ajax( {
		...
		success: function ( res ) {
			...
			temp = `<tr>
					...
					<td class="container-table-th" nowrap>SOC Sent Date</td>
					<td class="container-table-th" nowrap>SOC Guarantee Recv Date</td>
			...
			if ( Array.isArray( res ) && res.length > 0 ) {
				res.forEach( ( item, ind ) => {
					...
					temp = `<tr data-ctnrno="${item.ctnrno}"><td class="container-table-td" nowrap><input type='checkbox' id="se${nn}" name="se${nn}" value="${nn}"></td>
							...
							<td class="container-table-td" nowrap><input type='text' id="ss${nn}" name="ds${nn}" size="10" maxlength="10" value="${replaceBlank(item.socsent)}"></td>
							<td class="container-table-td" nowrap><input type='text' id="sg${nn}" name="ds${nn}" size="10" maxlength="10" value="${replaceBlank(item.socgrecv)}"></td>
